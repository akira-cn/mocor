...
module.exports = class Mock {
  ...
  constructor(name = 'Demo API', desc = 'API generated by mockingjay.') {
    this.#name = name;
    this.#desc = desc;
  }
...
`;
  ...
  compile() {
      ...
      if(contentType !== 'application/json') {
        const service = `//${context.host}/${context.path.replace(/^\//, '')}`;
        context.set('content-type', 'text/html');
        const markdownBody = marked.parse(this.info(service));
